...
def run(args):
    ...
    train_dataset = Dataset(dataset_path='/media/zhihao/Chi_SamSungT7/KIT_Bimanual', gt_filename='bimacs_rgbd_data_ground_truth', 
    ...
    test_dataset = Dataset(dataset_path='/media/zhihao/Chi_SamSungT7/KIT_Bimanual', gt_filename='bimacs_rgbd_data_ground_truth', 
                 train_filename='train_cross_subject.txt', test_filename='test_cross_subject.txt', dataset='test', 
                 hand='right_hand', action_list='action_list.json', frames_per_clip=50, frame_skip=1, 
                 pose_path='body_pose',obj_path='2d_object', with_obj=True, obj_dim=3)
    # # set the split ratio
    # split_ratio = 0.8
    ...
    print("Number of clips in the train dataset:{}".format(int(len(train_dataset))))
    print("Number of clips in the test dataset:{}".format(int(len(test_dataset))))
    ...
    for steps in range(max_steps):
        ...
        for train_batchind, data in loop:
            ...
            # get the inputs
            # print("OK.......")
            skeleton_data, labels, vid_idx, frame_pad, object_data, _, _= data
            ...
            if args.arch == 'EGCN':
                ...
                # print("Check hand1 joint:", inputs[0, 0, :, 10, 24, 0])
                # print("Check hand2 joint:", inputs[0, 0, :, 10, 10, 0])
                # print("Check object:", inputs[0, 0, :, 20, 26, 0])
            else:
                # start = time.time()
